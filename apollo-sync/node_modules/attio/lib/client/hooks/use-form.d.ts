...
type RecordCombobox<TSchema extends FormSchema> = (props: {
    /** The label of the record combobox field */
    label: string;
    /** The path to the value of the record combobox field, e.g. `"company"` or `"team.staffManager"` */
    name: PathTo<TSchema, "attio-record">;
    /** The optional placeholder text for the record combobox field */
    placeholder?: string;
    /**
     * The optional placeholder text for the search input
     *
    ...
    searchPlaceholder?: string;
    /**
     * The slugs of objects that can be selected.
     *
     * @default ["people", "companies", "deals", "workspaces", "users"]
     */
    objectSlug?: ObjectSlug | Array<ObjectSlug>;
    /** Whether the record combobox field is disabled */
    disabled?: boolean;
}) => JSX.Element;
type UserCombobox<TSchema extends FormSchema> = (props: {
    /** The path to the value of the user combobox field, e.g. `"assignedTo"` or `"team.manager"` */
    name: PathTo<TSchema, "string">;
...
export interface FormApi<TSchema extends FormSchema> {
     ...
     * A date time input field.
     */
    Experimental_DateTimeInput: DateTimeInput<TSchema>;
    /**
     * A date (YYYY-MM-DD) input field.
     */
    Experimental_PlainDateInput: PlainDateInput<TSchema>;
    /**
     * A combobox input field.
     */
     ...
     */
    Experimental_AttioUserCombobox: UserCombobox<TSchema>;
    /**
     * A Attio record combobox input field.
     */
    Experimental_AttioRecordCombobox: RecordCombobox<TSchema>;
    /**
     * A component used to render a collection of inputs.
