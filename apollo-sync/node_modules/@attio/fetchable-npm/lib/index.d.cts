...
type AllPotentiallyComplete$1<TRecord extends Record<any, any>> = {
    [TKey in keyof TRecord]: ExtractValue$2<TRecord[TKey]> extends never ? false : true;
}[keyof TRecord] extends true ? true : false;
 ...
 * isolate the spread array in the middle of it (if there is one at all).
 */
type PartiallyCombinedArray<TCombinedHeadValues extends Array<any>, TUncombined extends Array<any>, TCombinedTailValues extends Array<any>> = TUncombined extends Array<never> ? Complete<[...TCombinedHeadValues, ...TCombinedTailValues]> : TUncombined extends [infer THead, ...infer TRest] ? (ExtractValue$1<THead> extends never ? never : PartiallyCombinedArray<[
    ...TCombinedHeadValues,
    ExtractValue$1<THead>
], TRest, TCombinedTailValues>) | (ExtractNonComplete$1<THead> extends never ? never : ExtractNonComplete$1<THead>) : TUncombined extends [...infer TRest, infer TTail] ? (ExtractValue$1<TTail> extends never ? never : PartiallyCombinedArray<TCombinedHeadValues, TRest, [
    ExtractValue$1<TTail>,
    ...TCombinedTailValues
]>) | (ExtractNonComplete$1<TTail> extends never ? never : ExtractNonComplete$1<TTail>) : TUncombined extends Array<infer TElement> ? (ExtractValue$1<TElement> extends never ? never : Complete<[
    ...TCombinedHeadValues,
    ...Array<ExtractValue$1<TElement>>,
    ...TCombinedTailValues
]>) | (ExtractNonComplete$1<TElement> extends never ? never : ExtractNonComplete$1<TElement>) : never;
...
type AllPotentiallyComplete<TRecord extends Record<any, any>> = {
    [TKey in keyof TRecord]: ExtractValue<TRecord[TKey]> extends never ? false : true;
}[keyof TRecord] extends true ? true : false;
...
export { type AsyncResult, type Complete, type CompleteState, type ErrorOf, type Errored, type ErroredState, type Fetchable, type Loadable, type Pending, type PendingState, type Result, type ValueOf, bind, bindError, combine, combineAsync, complete, errored, fromPromise, fromThrowable, isComplete, isErrored, isPending, map, mapError, pending, valueOrElse };
